...
public class PrintScannerInput {
	...
	//approach 2 of the above function
	...
	//second approach of the above function
	...
	//if input is less than 0 dont perform sum. this function does not calculate
	//sum for negative value
	...
	//don't consider 999 as an integer its just an indication to stop the program
